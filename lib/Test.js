			...
			return start()
				...
				.then(function () {
					...
					if (self._usesRemote && !self.isAsync) {
						console.warn("This test uses the remote but isn't marked as async! Intern won't wait for your test actions to complete.");
						console.warn("You probably want to call this.async() or return a promise.");
					}
