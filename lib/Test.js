define([
	...
	Test.prototype = {
		...
		get timeout() {
			...
			else if (this.parent && this.parent.timeout != null) {
		...
		run: function () {
			...
			// TODO: Test
			this.async = this.constructor.prototype.async;
			...
			return start()
				.then(function () {
					...
					if (result && result.then) {
						...
						self.restartTimeout = function (timeout) {
						...
						var task = new Promise(function (resolve, reject, progress, setCanceler) {
				...
				.finally(function () {
					...
					self.restartTimeout = self.constructor.prototype.restartTimeout;
					timer && clearTimeout(timer);
				})
				.then(function () {
					self.hasPassed = true;
