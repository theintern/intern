define([
	...
	Runner.prototype = lang.mixin(Object.create(_super), /** @lends module:intern/lib/executors/Runner# */ {
		...
		_createSuites: function (config, tunnel, overrides) {
			function createRootSuite(environmentType) {
				var suite = new Suite({
			...
			return resolveEnvironments(config.capabilities, config.environments, tunnel.getEnvironments())
				.map(createRootSuite);
		},
