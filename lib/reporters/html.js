	...
	var htmlReporter = {
		start: function () {
			...
			for (i = 0; i < summaryHeaders.length; i++) {
				...
				cellNode.className = summaryHeaders[i].toLowerCase();
			...
			for (i = 0; i < summaryHeaders.length; i++) {
				...
				summaryNodes[i].className = 'numeric '+summaryHeaders[i].toLowerCase();
		...
		'/test/end': function (test) {
			...
			console.log("Tests in suite "+testsInSuite);
