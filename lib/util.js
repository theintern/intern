...
define([
	...
	// Keep pointers to the timer functions in case somethings mocks them
	var _setTimeout = (window || global).setTimeout;
	var _setInterval = (window || global).setInterval;
	var _setImmediate = (window || global).setImmediate;
	var _clearTimeout = (window || global).clearTimeout;
	...
	return {
		...
		setTimeout: function () {
			return _setTimeout.apply(undefined, arguments);
		},

		clearTimeout: function () {
			_clearTimeout.apply(undefined, arguments);
		},

		setInterval: function () {
			return _setInterval.apply(undefined, arguments);
		},

		setImmediate: function () {
			return _setImmediate.apply(undefined, arguments);
		}
	};
});
