...
define([
	...
	'./EnvironmentType',
	'diff',
	'dojo-core/has!host-node?dojo/node!glob',
	'dojo-core/has!host-node?dojo/node!path',
	'dojo-core/has!host-node?dojo/node!istanbul/lib/hook',
	'dojo-core/has!host-node?dojo/node!istanbul/lib/instrumenter',
	'dojo-core/has!host-node?dojo/node!source-map',
	...
	function serialize(object) {
		...
		function writeObject(object) {
			...
			if (isArray) {
				...
				output += (has.default('function-name') ? (object.name || '<anonymous>') : '<function>') + '({';
			}
			else {
				output += '{';
			}
	 ...
	 * special cases for AMD identifiers, like 'dojo-core/has!host-node?fs'.
	 */
