define([
	 ...
	 * @param {string} instrumenterCoverageVariable Name be used for the code coverage variable
	 */
	function getInstrumenter(instrumenterCoverageVariable) {
		if (!instrumenter) {
			instrumenter = new Instrumenter({
				coverageVariable: instrumenterCoverageVariable,
	...
	return {
		...
		setInstrumentationHooks: function (config, basePath) {
			...
			function hookTransformer(code, filename) {
				return self.instrument(code, pathUtil.resolve(filename), config.coverageVariable);
			}
		 ...
		 */
		instrument: function (filedata, filepath, instrumenterCoverageVariable) {
			var instrumenter = getInstrumenter(instrumenterCoverageVariable);
