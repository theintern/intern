define([
	...
	ClientSuite.prototype = lang.mixin(Object.create(_super), /** @lends module:intern/lib/ClientSuite# */ {
		...
		// TODO: Change this from using sessionId to identifying the suite in the root suites array by index so that
		// sessions be safely reset in the middle of a test run
		run: function () {
			var self = this;
