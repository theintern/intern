...
declare module 'leadfoot/Command' {
	...
	class Command<T> {
		 ...
		 *
		 * @param using The element retrieval strategy to use. See {@link module:leadfoot/Session#find} for options.
		 * @param value The strategy-specific value to search for. See {@link module:leadfoot/Session#find} for details.
		 */
		findDisplayed(using: string, value: string): Command<Element>;
