...
<tr>
	<th scope="row">True<sup><a href="#ref1">1</a></sup> browser events</th>
	<td>Yes</td>
	<td>No</td>
	<td>No</td>
	<td>No</td>
...
<tr>
	<th scope="row">Stand-alone<sup><a href="#ref1">2</a></sup> browser support</th>
	<td>Yes</td>
	<td>Yes</td>
...
<tr>
	...
	<td>Yes</td>
	<td>No<sup><a href="#ref3">3</a></sup></td>
	<td>Yes</td>
	<td>Yes</td>
	<td>Yes</td>
	<td>Yes</td>
...
<tr>
	<th scope="row">Any<sup><a href="#ref4">4</a></sup> assertion library</th>
	<td>Yes</td>
	<td>No</td>
	<td>Yes</td>
	<td>No</td>
...
<a id="ref1">1</a>: True events are not generated by JavaScript within the sandbox, so are able to accurately emulate how a user
      actually interacts with the application. Synthetic events generated by other test frameworks are limited by
	  browser security restrictions.
<a id="ref2">2</a>: Stand-alone means that unit tests can be executed in a browser by navigating to a URL without needing any special
      HTTP server or proxy for support.
<a id="ref3">3</a>: Some older versions of QUnit can be used in conjunction with a 3rd party module to run on Node.js, but newer
      versions do not support Node.js and will break even with the use of 3rd party modules.
<a id="ref4">4</a>: If it throws an error on failure, it works with Test Stack.
