...
<tr>
	<th>Feature</th>
	<th>[Test Stack](https://github.com/csnover/dojo2-teststack)</th>
	<th>[QUnit](http://qunitjs.com)</th>
	<th>[Mocha](http://visionmedia.github.com/mocha/)</th>
	<th>[Jasmine](http://pivotal.github.com/jasmine/)</th>
	<th>[BusterJS](http://busterjs.org/)</th>
	<th>[Testacular](http://testacular.github.com/)</th>
</tr>
<tr>
...
<tr>
	<th scope="row">True[^1] browser events</th>
	<td>Yes</td>
	<td>No</td>
	<td>No</td>
	<td>No</td>
...
<tr>
	<th scope="row">Stand-alone[^2] browser support</th>
	<td>Yes</td>
	<td>Yes</td>
...
<tr>
	<th scope="row">Any[^4] assertion library</th>
	<td>Yes</td>
	<td>No</td>
	<td>Yes</td>
	<td>No</td>
...
[^1]: True events are not generated by JavaScript within the sandbox, so are able to accurately emulate how a user
      actually interacts with the application. Synthetic events generated by other test frameworks are limited by
	  browser security restrictions.
[^2]: Stand-alone means that unit tests can be executed in a browser by navigating to a URL without needing any special
      HTTP server or proxy for support.
[^3]: Some older versions of QUnit can be used in conjunction with a 3rd party module to run on Node.js, but newer
