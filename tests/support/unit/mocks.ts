...
import { Handle, duplicate } from 'src/common';
...
import Suite, { SuiteOptions, RootSuiteOptions } from 'src/core/lib/Suite';
import Test, { TestOptions } from 'src/core/lib/Test';
