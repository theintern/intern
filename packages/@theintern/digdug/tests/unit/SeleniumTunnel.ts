...
import SeleniumTunnel, { isWebDriver } from '../../src/SeleniumTunnel';
import { Response } from '@theintern/common';
import { BrowserName } from '../../src/types';
import { mockImport } from '@theintern-dev/test';
...
suite('tunnels/SeleniumTunnel', () => {
  suite('config', () => {
    ...
    test('config object', () => {
      const tunnel = new SeleniumTunnel({
        drivers: [
          { executable: 'package.json', url: '', seleniumProperty: '' },
        ],
      });
