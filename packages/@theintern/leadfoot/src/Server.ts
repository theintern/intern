...
export interface ServerOptions extends RequestOptions {
  logger?: Logger;
}
...
export default class Server {
  ...
  /**
   * An emitter that will be used for log events
   */
  logger: Logger;
  ...
  constructor(url: string | LeadfootURL, options: ServerOptions = {}) {
    ...
    const { logger, ...requestOptions } = options;
  ...
  private _detectCapabilities(session: Session): Promise<void | Session> {
    ...
    const logResult = (message: string) => {
      return (value: any) =>
        this.logger.log(`${message}: ${value}`).then(() => value);
    };
    ...
    const discoverServerFeatures = () => {
      ...
      if (capabilities.remoteFiles == null) {
        this.logger.log('Checking for remoteFiles...');
      ...
      if (capabilities.supportsSessionCommand == null) {
        this.logger.log('Checking supportsSessionCommands...');
      ...
      if (capabilities.supportsGetTimeouts == null) {
        this.logger.log('Checking supportsGetTimeouts...');
      ...
      if (capabilities.usesWebDriverTimeouts == null) {
        this.logger.log('Checking usesWebDriverTimeouts...');
      ...
      if (capabilities.usesWebDriverWindowCommands == null) {
        this.logger.log('Checking usesWebDriverWindowCommands...');
      ...
      if (capabilities.usesHandleParameter == null) {
        this.logger.log('Checking usesHandleParameter...');
      ...
      if (capabilities.brokenSessionList == null) {
        this.logger.log('Checking brokenSessionList...');
      ...
      if (capabilities.returnsFromClickImmediately == null) {
        this.logger.log('Checking returnsFromClickImmediately...');
      ...
      if (capabilities.noKeysCommand == null) {
        this.logger.log('Checking noKeysCommand...');
      ...
      if (capabilities.noElementDisplayed == null) {
        this.logger.log('Checking noElementDisplayed...');
    ...
    const discoverFeatures = () => {
      ...
      if (isSafari(capabilities, 0, 10) && isMac(capabilities)) {
        this.logger.log('Skipping feature tests for Mac Safari < 10');
      ...
      if (capabilities.rotatable == null) {
        this.logger.log('Checking rotatable...');
      ...
      if (capabilities.locationContextEnabled) {
        this.logger.log('Checking locationContextEnabled...');
      ...
      if (capabilities.webStorageEnabled) {
        this.logger.log('Checking webStorageEnabled...');
      ...
      if (capabilities.applicationCacheEnabled) {
        this.logger.log('Checking applicationCacheEnabled...');
      ...
      if (capabilities.takesScreenshot == null) {
        ...
        this.logger.log('Checking takesScreenshot...');
      ...
      if (capabilities.supportsExecuteAsync == null) {
        this.logger.log('Checking supportsExecuteAsync...');
      ...
      if (
        ...
        this.logger.log('Checking mouseEnabled...');
      ...
      if (capabilities.touchEnabled == null) {
        this.logger.log('Checking touchEnabled...');
      ...
      if (capabilities.dynamicViewport == null) {
        this.logger.log('Checking dynamicViewport...');
      ...
      if (capabilities.supportsNavigationDataUris == null) {
        this.logger.log('Checking supportsNavigationDataUris...');
      ...
      if (capabilities.supportsCssTransforms == null) {
        this.logger.log('Checking supportsCssTransforms...');
    ...
    const discoverDefects = (): Promise<Capabilities> => {
      ...
      // are not http/https
      if (isSafari(capabilities, 0, 10) && isMac(capabilities)) {
        this.logger.log('Skipping defect tests for Mac Safari < 10');
        return Promise.resolve({});
      }
      ...
      if (capabilities.brokenActiveElement == null) {
        this.logger.log('Checking for brokenActiveElement...');
      ...
      if (capabilities.brokenDeleteCookie == null) {
        if (capabilities.browserName === 'selendroid') {
          ...
          this.logger.log('Checking for brokenDeleteCookie...');
      ...
      if (capabilities.brokenHtmlTagName == null) {
        this.logger.log('Checking for brokenHtmlTagName...');
      ...
      if (capabilities.brokenNullGetSpecAttribute == null) {
        this.logger.log('Checking for brokenNullGetSpecAttribute...');
      ...
      if (capabilities.brokenElementSerialization == null) {
        this.logger.log('Checking for brokenElementSerialization...');
      ...
      if (capabilities.brokenExecuteUndefinedReturn == null) {
        this.logger.log('Checking for brokenExecuteUndefinedReturn...');
      ...
      if (capabilities.brokenExecuteElementReturn == null) {
        this.logger.log('Checking for brokenExecuteElementReturn...');
      ...
      if (capabilities.brokenElementDisplayedOpacity == null) {
        this.logger.log('Checking for brokenElementDisplayedOpacity...');
      ...
      if (capabilities.brokenElementDisplayedOffscreen == null) {
        this.logger.log('Checking for brokenElementDisplayedOffscreen...');
      ...
      if (capabilities.brokenVisibleText == null) {
        this.logger.log('Checking for brokenVisibleText...');
      ...
      if (capabilities.brokenWhitespaceNormalization == null) {
        this.logger.log('Checking for brokenWhitespaceNormalization...');
      ...
      if (capabilities.brokenLinkTextLocator == null) {
        this.logger.log('Checking for brokenLinkTextLocator...');
      ...
      if (capabilities.brokenComputedStyles == null) {
        this.logger.log('Checking for brokenComputedStyles...');
      ...
      if (capabilities.brokenOptionSelect == null) {
        ...
        this.logger.log('Checking for brokenOptionSelect...');
      ...
      if (capabilities.brokenPageSource == null) {
        this.logger.log('Checking brokenPageSource...');
      ...
      if (capabilities.brokenSubmitElement == null) {
        ...
        this.logger.log('Checking brokenSubmitElement...');
      ...
      if (capabilities.brokenWindowSize == null) {
        this.logger.log('Checking brokenWindowSize...');
      ...
      if (capabilities.brokenWindowMaximize == null) {
        this.logger.log('Checking brokenWindowMaximize...');
      ...
      if (capabilities.fixedLogTypes == null) {
        this.logger.log('Checking fixedLogTypes...');
      ...
      if (capabilities.brokenZeroTimeout == null) {
        this.logger.log('Checking brokenZeroTimeout...');
      ...
      if (capabilities.brokenWindowSwitch == null) {
        this.logger.log('Checking brokenWindowSwitch...');
      ...
      if (capabilities.brokenParentFrameSwitch == null) {
        this.logger.log('Checking brokenParentFrameSwitch...');
      ...
      if (capabilities.brokenElementPosition == null) {
        this.logger.log('Checking brokenElementPosition...');
      ...
      if (capabilities.brokenRefresh == null) {
        this.logger.log('Checking brokenRefresh...');
      ...
      if (capabilities.brokenMouseEvents == null && capabilities.mouseEnabled) {
        ...
        this.logger.log('Checking brokenMouseEvents...');
        ...
        if (capabilities.brokenHtmlMouseMove == null) {
          this.logger.log('Checking brokenHtmlMouseMove...');
      ...
      if (capabilities.brokenDoubleClick == null) {
        this.logger.log('Checking brokenDoubleClick...');
      ...
      if (capabilities.touchEnabled) {
        ...
        if (capabilities.brokenLongTap == null) {
          this.logger.log('Checking brokenLongTap...');
          ...
          if (capabilities.brokenMoveFinger == null) {
            this.logger.log('Checking brokenMoveFinger...');
          ...
          if (capabilities.brokenTouchScroll == null) {
            this.logger.log('Checking brokenTouchScroll...');
        ...
        if (capabilities.brokenFlickFinger == null) {
          this.logger.log('Checking brokenFlickFinger...');
      ...
      if (
        ...
        this.logger.log('Checking brokenCssTransformedSize...');
      ...
      if (!isMsEdge(capabilities)) {
        ...
        if (capabilities.brokenElementEnabled == null) {
          this.logger.log('Checking brokenElementEnabled...');
