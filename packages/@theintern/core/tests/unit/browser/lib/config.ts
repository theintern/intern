import { suite, test, before, beforeEach } from 'src/lib/interfaces/tdd';
import { mockImport } from 'tests/support/mockUtil';
import { createSandbox } from 'sinon';
import { Response } from '@theintern/common';

import * as _config from 'src/browser/lib/config';

suite('browser/lib/config', () => {
  ...
  suite('getDefaultInternPath', () => {
    test('intern script exists', () => {
      mockScripts.value([
        { src: 'foo' },
        { src: '/bar/dist/browser/intern.js' },
      ]);
